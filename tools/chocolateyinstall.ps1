...
$url        = 'https://puppet-pdk.s3.amazonaws.com/pdk/1.0.0.1/repos/windows/pdk-1.0.0.1-x64.msi' # download url, HTTPS preferred$url        = 'https://puppet-pdk.s3.amazonaws.com/pdk/0.6.0.0/repos/windows/pdk-0.6.0.0-x64.msi' # download url, HTTPS preferred
